...
# sq_basin_mg, z = read_esri_ascii('Square_TestBasin.asc', name='topographic__elevation')
# sq_basin_mg.set_closed_boundaries_at_grid_edges(True, True, True, True)
# imshow_grid(sq_basin_mg, 'topographic__elevation')
